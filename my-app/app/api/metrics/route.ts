...
import { getModelMetrics } from '@/lib/ml-detection';
  ...
  try {
    ...
    return NextResponse.json({
      ...
      research: {
        ...
        Isolation Forest, Autoencoders, and K-Means Clustering. Our ensemble approach achieves 
        ...
        contributions: [
          'Novel ensemble method combining unsupervised learning techniques',
